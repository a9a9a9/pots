...
<div class="partner-body">
	...
	<form class="form" role="form" name="flist">
		<input type="hidden" name="ap" value=""> <input type="hidden"
			name="save_stx" value=""> <input type="hidden" name="sort"
			value="">
		...
		<div class="partner-well">
			...
			</select> <input type="text" name="stx" value="" id="stx" class="search"
	...
	<form class="form" role="form" name="fitemlistupdate" method="post"
		action="./itemlistupdate.php"
		onsubmit="return fitemlist_submit(this);" autocomplete="off">
		<input type="hidden" name="ap" value="list"> 
				...
				<tbody>
					<tr>
						<td>
							...
							</div> <input type="hidden" name="it_id[0]" value="1659354235">
						</td>
						<td><a
							href="https://buts.co.kr/shop/item.php?it_id=1659354235"
							class="item-name"> <span class="brand"><img
									src="https://buts.co.kr/thema/Buts/colorset/category/6040.jpg"
									alt=""></span> <span class="name">kg</span> <span
								class="lightgrey"> 파티번호 : 1659354235 / 기타 / 기타 </span>
						</a></td>
						<td><strong>0</strong>원(<strong>10</strong>원)</td>
						...
						<td class="text-center"><a
							href="./?ap=item&amp;w=c&amp;it_id=1659354235&amp;fn=2&amp;ca_id=6040"
							class="button round border button-red">복사</a></td>
					</tr>
					<tr>
						<td>
							<div class="input-check" style="margin-right: -8px;">
							...
							</div> <input type="hidden" name="it_id[1]" value="1658071092">
						</td>
						<td><a
							href="https://buts.co.kr/shop/item.php?it_id=1658071092"
							class="item-name"> <span class="brand"><img
									src="https://buts.co.kr/thema/Buts/colorset/category/1080.jpg"
									alt=""></span> <span class="name">디즈니플러스 두달</span> <span
								class="lightgrey"> 파티번호 : 1658071092 / #디즈니 / 영상 </span>
						</a></td>
						<td><strong>3,960</strong>원(<strong>90</strong>원)</td>
						<td><strong>0명(총 2명)</strong></td>
						<td><strong>44</strong>일</td>

						<td><span class="lightgrey"> 2022.09.17 </span></td>
						<td class="text-center">2022-07-18 00:20:13</td>
						<td class="text-center"><a
							href="./?ap=item&amp;w=u&amp;it_id=1658071092&amp;fn=2&amp;ca_id=1080"
							class="button round border button-purple">수정</a> <a
							href="./?ap=item&amp;w=c&amp;it_id=1658071092&amp;fn=2&amp;ca_id=1080"
							class="button round border button-red">복사</a></td>
					</tr>
					<tr>
						<td>
							...
							</div> <input type="hidden" name="it_id[2]" value="1655529789">
						</td>
						<td><a
							href="https://buts.co.kr/shop/item.php?it_id=1655529789"
							class="item-name"> <span class="brand"><img
									src="https://buts.co.kr/thema/Buts/colorset/category/1080.jpg"
									alt=""></span> <span class="name">디즈니플러스 한달찍먹 싸다쏴</span> <span
								class="lightgrey"> 파티번호 : 1655529789 / #디즈니 / 영상 </span>
						</a></td>
						...
						<td><span class="lightgrey"> 종료 </span></td>
						<td class="text-center">2022-06-18 14:23:54</td>
						<td class="text-center"><a
							href="./?ap=item&amp;w=c&amp;it_id=1655529789&amp;fn=2&amp;ca_id=1080"
							class="button round border button-red">복사</a></td>
					</tr>
					<tr>
						<td>
							...
							</div> <input type="hidden" name="it_id[3]" value="1649722564">
						</td>
						<td><a
							href="https://buts.co.kr/shop/item.php?it_id=1649722564"
							class="item-name"> <span class="brand"><img
									src="https://buts.co.kr/thema/Buts/colorset/category/1080.jpg"
									alt=""></span> <span class="name">디즈니플러스 한달만</span> <span
								class="lightgrey"> 파티번호 : 1649722564 / #디즈니 / 영상 </span>
						</a></td>
						...
						<td><span class="lightgrey"> 종료 </span></td>
						<td class="text-center">2022-04-12 09:21:30</td>
						<td class="text-center"><a
							href="./?ap=item&amp;w=c&amp;it_id=1649722564&amp;fn=2&amp;ca_id=1080"
							class="button round border button-red">복사</a></td>
					</tr>
					<tr>
						<td>
							...
							</div> <input type="hidden" name="it_id[4]" value="1636677901">
						</td>
						<td><a
							href="https://buts.co.kr/shop/item.php?it_id=1636677901"
							class="item-name"> <span class="brand"><img
									src="https://buts.co.kr/thema/Buts/colorset/category/1080.jpg"
									alt=""></span> <span class="name">디즈니플러스 한달찍먹</span> <span
								class="lightgrey"> 파티번호 : 1636677901 / #디즈니 / 영상 </span>
						</a></td>
						<td><strong>0</strong>원(<strong>83</strong>원)</td>
						...
						<td><span class="lightgrey"> 종료 </span></td>
						<td class="text-center">2021-11-12 09:50:46</td>
						<td class="text-center"><a
							href="./?ap=item&amp;w=c&amp;it_id=1636677901&amp;fn=2&amp;ca_id=1080"
							class="button round border button-red">복사</a></td>
					</tr>
				</tbody>
			</table>
