			...
			<div class="width-container">
				...
				<div class="table-row">
					<div class="subject" style="margin-left: 20px;">제목 
						<input type=text required name='square_title' 
							style="width: 90%; margin-left: 70px;" />
					</div>
				</div>
				<div class="table-row">
					<div class="subject" style="margin-left: 20px;">작성자 
						<input type="text" name='nick' value="${sessionScope.nick }" disabled 
				...
				<div class="table-view-article">
						...
						<textarea class="board_content" name="square_content" required placeholder="내용 작성"></textarea>
