		...
		<div class="body">
			<div class="width-container">
				...
				<div class="title-wrap">
					<div class="title">
						<a href="/index?formpath=myPartyJoined" class="text"><span
							class="text-purple">참여파티</span></a> <a
							href="/index?formpath=myPartyCreated" class="text"
							style="margin-left: 20px;">생성파티</a>
					</div>
					<div class="title">* 사용기간이 종료된 파티는 참여파티에 보이지 않습니다.</div>
				</div>
				<div class="item-list">
					...
					<div class="item-row-my item-row">
						...
						<div class="item-info">
							<div class="item-date">
								22.08.21 <span class="pc-inline">까지</span>(<strong>2</strong>일)
							</div>
						...
						<div class="item-buttons">
							<a href="./item.php?it_id=1660890917&amp;page=1"
								class="button border round button-purple">파티장 문의</a> <a
								href="#popup-account1660890917"
								class="popup-inline button border round button-red">ID/PW 보기</a>
						</div>
						<a href="./item.php?it_id=1660890917&amp;page=1"
							class="item-button"></a>
					</div>
					<div id="popup-account1660890917"
						class="popup-magnific mfp-hide white-popup-block">
						<h3>
							<span class="text-purple">계정</span> 정보
						</h3>
						<div class="popup-table">
							<table>
								...
								<tbody>
									<tr>
										<th>계정</th>
										<td><input id="myID1660890917"
											onclick="copyText('myID1660890917')" value="kg1234@" readonly
											style="border: 0px;" class="text-purple"></td>
									</tr>
									<tr>
										<th>비밀번호</th>
										<td><input id="myPW1660890917"
											onclick="copyText('myPW1660890917')" value="1234" readonly
											style="border: 0px;" class="text-purple"></td>
									</tr>
								</tbody>
							</table>
				...
				<div id="item_list-nav" class="item-nav">
					<a
						href="https://buts.co.kr/skin/apms/list/Miso-Basic4/list_my.rows.php?lt=Buts&amp;ls=Miso-Basic4&amp;ca_id=10&amp;npg=0&amp;page=2"></a>
				</div>
				
				
				<div class="item-more">
					<a href="#" title="더보기"> 더보기 <span class="color"> <span
							class="sound_only">더보기</span>
					</span>
					</a>
				</div>

				<div class="button-align right">
					<a href="https://buts.co.kr/shop/partner/?ap=item"
						class="button small button-red">등록</a> <a
						href="https://buts.co.kr/shop/partner/"
						class="button small button-blue">관리</a>
				</div>
