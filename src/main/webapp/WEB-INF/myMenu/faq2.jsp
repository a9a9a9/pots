							...
							<div class="select">
								...
								<div id="faq_collapse2" class="panel-collapse collapse">
									<div class="article"><p>파티모집은 리스트에 노출된 [파티 만들기] 버튼을 통해 진행 가능합니다.</p>
										...
										<p> <br></p>
										<p>※ 전문판매자와 일반판매자 전환은 1:1문의 및 팟츠 채널을 통하여 변경 요청 하실 수 있습니다.</p>
									</div>
								</div>
							</div>
						</li>
							...
							<div class="select">
								...
								<div id="faq_collapse3" class="panel-collapse collapse">
									<div class="article">파티 참여 즉시 [내 파티보기]에서 해당 파티에 대한 정보를 확인 하실 수 있습니다.
										...
										<p>상세페이지 하단의 팟츠Talk를 통하여 문의 진행이 가능합니다.</p>
										<p><br> </p>
										<p>※ 팟츠Talk 기능은 2021년 2월 이후 제공 될 예정입니다.</p>
									</div>
								</div>
							</div>
						</li>
							...
							<div class="select">
								...
								<div id="faq_collapse4" class="panel-collapse collapse">
									<div class="article"><p>파티장의 서비스 관리 미숙이나 부실로 인하여 이용이 중단되거나 접속이 불가한 경우</p>
										...
										<p>파티장 문의처나 하단에 팟츠Talk를 통하여 문제해결 요청이 가능합니다.</p>
										<p><br> </p>
										<p>문제해결 요청 이후 24시간 내에 응답이 없거나 문제가 해결되지 않은 경우 팟츠에서 환불신청이 가능하며</p>
										<p>팟츠에서 내용 확인 후 사용하지 못한 기간에 대해서 100% 환불을 진행해 드립니다.</p>
										<p><br> </p>
						...
						<li>
							<div class="select">
								...
								<div id="faq_collapse6" class="panel-collapse collapse">
									<div class="article"><p>팟츠에서는 참여자(파티원)들의 개인 연락처를 파티장에게 제공하지 않습니다.</p>
										<p><br> </p>
										<p>다만 해당 파티의 파티 상세페이지에 참여한 파티원을 클릭해서 '요청보내기' 또는</p>
										<p>하단에 팟츠 TALK '무엇이든 물어 보이소'에서 참여한 파티원에게 메시지를 작성 및 알림톡을로 내용 전달 가능합니다.</p>
										<p><br> </p>
										<p>또한 팟츠에서는 파티 모집 시 파티원들의 연락처 및 개인정보를 수집하는 행위를 일체 금하고 있으며,</p>
										<p>위반 시 해당 계정에 사전 통보 없이 제한 조치를 진행할 수 있습니다.</p>
										<p><br> </p>
										<p>부득이 하게 파티원들과 연락이 필요한 경우 팟츠 '채널톡'을 통하여 문의남겨 주시면 도와 드립니다.</p>
									</div>
								</div>
							</div>
						</li>
