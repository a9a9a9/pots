...
<div class="width-container">
	...
	<div class="mw-800 form-clause mg-top-minus">
		...
		<form name="fregister" id="fregister"
			action="https://buts.co.kr/bbs/register_form.php"
...
.page-content p {
	...
	padding: 0;
				...
				<div class="page-content">
					...
					<p>이 약관은 벗츠 회사(전자상거래 사업자로 이하 "회사"라 한다)가 운영하는 벗츠 쇼핑몰(이하 "몰"이라
			...
			<div class="h3">
				<span class="text-purple">개인정보</span> 처리방침
			</div>
			<div class="form-round scroll">
...
.page-content p {
				...
				<div class="page-content">
					...
					<ol>
						...
						<li>또는 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에 문의하시기 바랍니다.
							<ol>
								<li>개인정보 침해신고센터(한국인터넷진흥원 운영) : (국번없이) 118 (<a
									href="https://privacy.kisa.or.kr" target="_blank">privacy.kisa.or.kr</a>)
								</li>
								<li>개인정보 분쟁조정위원회(국번없이) : 1833-6972 (<a
									href="https://www.kopico.go.kr" target="_blank">www.kopico.go.kr</a>)
								</li>
								<li>대검찰청 사이버범죄수사단 : 02-3480-3573 (<a
									href="https://www.spo.go.kr" target="_blank">www.spo.go.kr</a>)
								</li>
								<li>경찰청 사이버안전국 : (국번없이) 182 (<a
									href="https://cyberbureau.police.go.kr" target="_blank">cyberbureau.police.go.kr</a>)
								</li>
							</ol>
						</li>
					</ol>
	...
	<div style="margin-bottom: 20px;">
		<div style="color: #fff; background-color: #0b8aff; border-color: #428bca; height:50px; padding:15px; font-size:14px;">SNS 계정으로 가입</div>
		<div class="panel-body" style="background:#2f2f2f;">
			<div class="sns-wrap">
								<a href="https://buts.co.kr/plugin/social/popup.php?provider=naver&amp;url=https://buts.co.kr/bbs/register.php" class="sns-icon social_link sns-naver" title="네이버">
					<span class="ico"></span>
					<span class="txt">네이버으로 회원가입하기</span>
				</a>
												<a href="https://buts.co.kr/plugin/social/popup.php?provider=kakao&amp;url=https://buts.co.kr/bbs/register.php" class="sns-icon social_link sns-kakao" title="카카오">
					<span class="ico"></span>
...
<div style="padding: 15px; margin-bottom: 20px; background:#2f2f2f; color:#a9a9a9; text-align: center;" role="alert">
	 회원가입약관 및 개인정보처리방침안내의 내용에 동의하셔야 회원가입 하실 수 있습니다.
</div>

<form  name="fregister" id="fregister" action="https://buts.co.kr/bbs/register_form.php" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off" class="form" role="form">
<input type="hidden" name="pim" value="">
	<div class="panel-default" style="background:#2f2f2f; margin-bottom: 20px;">
		<div style="color: #fff; background-color: #0b8aff; border-color: #428bca; height:50px; padding:15px; font-size:14px;"> 회원가입약관</div>
		<div class="panel-body">
							<div class="register-term" style="color:#a9a9a9;">
					<style>
	.page-content { line-height:22px; word-break: keep-all; word-wrap: break-word; }
	.page-content .article-title { color:#7e69fe; font-weight:bold; padding-top:30px; padding-bottom:10px; }
...
<div class="page-content">
	...
	<ol>
		<li>이 약관은 2019년 10월 16일부터 시행합니다.
...
<div class="h30"></div>				</div>
		...
		<div style="padding: 10px 15px;background-color: #353535; color:#a9a9a9;">
            <label class="checkbox-inline"><input type="checkbox" name="agree" value="1" id="agree11"> 회원가입약관의 내용에 동의합니다.</label>
		</div>
	</div>

	<div class="panel-default"  style="background:#2f2f2f;">
		<div  style="color: #fff; background-color: #0b8aff; border-color: #428bca; height:50px; padding:15px; font-size:14px;">
							<a data-toggle="collapse" href="#privacy" aria-expanded="false" aria-controls="privacy" class="pull-right" style="color: #fff; ">전문보기</a>
						개인정보처리방침안내
		</div>
...
<div class="page-content">
	...
	<ol>
		...
		<ol>
			<li>개인정보 보호책임자 성명 : 김시진			
			<li>이메일 : manager@buts.co.kr
		</ol>
		<li>또는 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에 문의하시기 바랍니다.
		<ol>
	...
	<ol>
		<li>본 방침은 2019년 10월 16일부터 시행합니다.
	</ol>
...
<div class="h30"></div>				</div>
				...
				<table style="border-top:0px; color:#a9a9a9; border-bottom:1px solid #353535; width: 100%; max-width: 100%; padding:10px;" >
			<colgroup>
				<col width="40%">
				<col width="30%">
			</colgroup>
			...
			<tr style="border-bottom:1px solid #353535;" >
				<th style="border-top:0px; padding:10px;">목적</th>
				<th style="border-top:0px;">항목</th>
				<th style="border-top:0px;">보유기간</th>
			</tr>
			<tr style="border-bottom:1px solid #353535;" >
				<td style="padding:10px;">이용자 식별 및 본인여부 확인</td>
				<td>아이디, <br /> 이름, 비밀번호</td>
				<td>회원 탈퇴 후<br />1년까지</td>
			</tr>
			<tr style="border-bottom:1px solid #353535; " >
				<td style="padding:10px;">고객서비스 이용에 관한 통지, CS대응을 위한 이용자 식별</td>
				<td>연락처 (이메일, <br />휴대전화번호)</td>
				<td>회원 탈퇴 후<br />1년까지</td>
			</tr>
			</tbody>
		</table>
    ...
    <div class="text-center" style="padding-top:30px;">
        <button type="submit" style="color:#fff; background-color: #0b8aff; width:200px; height:60px; border:1px solid #0b8aff; font-size: 16px;">회원가입</button>
    </div>
</form> -->
	...
	<script>
		...
		function nwindow(var_url) {
			window.open(var_url, "", "width=400,height=400,left=600");
		}
	</script>
