		...
		<div class="body">
			<div class="width-container">
				...
				<div class="recommand-list">
					...
					<a href="http://www.youtube.com/watch?v=8zfYINYNS38" class="recommand-thumb popup-youtube"><img src="https://img.youtube.com/vi/8zfYINYNS38/mqdefault.jpg" alt="" /></a>
					<a href="http://www.youtube.com/watch?v=IRmyAPu31ys" class="recommand-thumb popup-youtube"><img src="https://img.youtube.com/vi/IRmyAPu31ys/mqdefault.jpg" alt="" /></a>
				</div>
				
				<div class="title-wrap">
					<div class="title"><a href="${root}artProc" class="text">도서/음악</a><a href="${root}ridiProc" class="button border round button-white">#리디북스</a></div>
