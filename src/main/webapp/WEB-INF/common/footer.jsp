...
<!-- footer -->
		...
		<div class="footer">
			...
			<div class="padding-left">
				...
				<a href="https://buts.co.kr/bbs/page.php?hid=provision" target="_blank" class="v-bar">이용약관</a>
				<a href="https://buts.co.kr/bbs/faq.php" target="_blank" class="v-bar">FAQ</a><br /><br />
				<span class="v-bar">대표 : 김시진</span>
				<span class="v-bar">경기도 성남시 분당구 서현동 245-4 엘지분당에클라트2차 1221호</span>
				<span>이메일 : <a href="mailto:manager@buts.co.kr">manager@buts.co.kr</a></span><br />
				...
				<span class="v-bar">통신판매업신고 : 제 2019-의정부송산-040호</span>
				<span>개인정보보호책임 : 김시진</span><br />
