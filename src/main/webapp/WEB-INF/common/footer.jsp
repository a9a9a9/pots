...
<!-- footer -->
		<div class="footer">
			...
			<div class="padding-left">
				...
				<a href="#" target="_blank" class="v-bar" onclick="return false;">회사소개</a>
				<a href="#" target="_blank" class="v-bar" onclick="return false;">제휴문의</a>
				<a href="#" class="v-bar" onclick="return false;">1:1문의하기</a>
		...
		<div class="footer">
			...
			벗츠는 소비자 보호와 안전거래를 위해고객센터(cucksdn@gmail.com)를 운영하고 있으며,분쟁이 발생 된 경우 별도의 분쟁처리절차에 의거분쟁해결 및 청약철회 등이 진행 됩니다.
			</div>
		</div>